...
// ===== บัญชีผู้ดูแล (admin) =====
// ใช้ป้องกันการแก้ไข/ลบนักเรียน และจัดการรายวิชา
// หมายเหตุ: รหัสนี้อยู่ฝั่งหน้าเว็บ ผู้ที่เปิดดู source จะเห็นได้ (เหมาะกับการกันคนทั่วไปในโรงเรียน)
window.ADMIN_USERNAME = "admin";
window.ADMIN_PASSWORD = "55667788";
